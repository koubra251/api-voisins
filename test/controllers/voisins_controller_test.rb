...
class VoisinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voisin" do
    assert_difference('Voisin.count') do
      post voisins_url, params: { voisin: { aboutme: @voisin.aboutme, address: @voisin.address, name: @voisin.name, number: @voisin.number } }
    end
  ...
  test "should update voisin" do
    patch voisin_url(@voisin), params: { voisin: { aboutme: @voisin.aboutme, address: @voisin.address, name: @voisin.name, number: @voisin.number } }
